...
------------------------------------------------ */
	...
	function qns_social_widget() {
		...
		parent::__construct( 'social_widget', __('Custom Social Widget', 'qns'), $widget_ops, $control_ops );
	}
...
------------------------------------------------ */
	...
	function widget( $args, $instance ) {
		...
		$social_tripadvisor = $instance['social_tripadvisor'];
		...
		if ( $title ) {
			...
			<ul class="social-icons clearfix">
				...
				<?php if($social_tripadvisor != '') { ?>
					<li><a target="_blank" href="<?php echo $social_tripadvisor; ?>"><span class="tripadvisor-icon"></span></a></li>
				<?php }?>
...
------------------------------------------------ */
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['social_tripadvisor'] = strip_tags( $new_instance['social_tripadvisor'] );
		return $instance;
	}
...
------------------------------------------------ */
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'social_tripadvisor' ); ?>"><?php _e('Tripadvisor URL:', 'qns') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id('social_tripadvisor'); ?>" name="<?php echo $this->get_field_name('social_tripadvisor'); ?>" value="<?php echo $instance['social_tripadvisor']; ?>" />
		</p>
